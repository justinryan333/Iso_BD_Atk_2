...
poisoned_train_set_normalized = torch.load('datasets/poisoned_train_set_normalized_0.01_0.01_5.pt')
test_set_normalized = torch.load('datasets/test_set_normalized_0.01_0.01_5.pt')
...
torch.save(model.state_dict(), 'model_poisoned_tg5.pth')
...
plt.tight_layout()
plt.savefig('learning_rate_and_loss_ep001.png')  # Save as PNG image
plt.savefig('learning_rate_and_loss_ep001.pdf')  # Save as PDF
